/** Programme Dénombrements
 * Permet de réaliser 3 types de calculs: permutation, arrangement et combinaison.
 * Author: inconnu
 * Date création: inconnue
 * Date modification: 24/11/2021
 */
...
namespace Denombrements
{
    class Program
    {
        ...
        /// </summary>
        /// <param name="valeurDepart"> valeur de départ de calcul </param>
        ...
        static long ProduitsEntiers(int valeurDepart, int valeurArrivee)
        {
            long produit = 1;
            ...
            while (choix != "0")
            {
                ...
                if (choix == "1" || choix == "2" || choix == "3")
                {
                    try
                    {
                        ...
                        if (choix == "1")
                        {
                            long permutation = ProduitsEntiers(1, nbTotal);
                        ...
                        else
                        {
                            ...
                            long arrangement = ProduitsEntiers(nbTotal - nbSousEnsemble + 1, nbTotal);
                            // choix: arrangement
                            if (choix == "2")
                            {
                            ...
                            {
                                long combinaison = arrangement / ProduitsEntiers(1, nbSousEnsemble);
